# OpenWrt AI Copilot — Documentation

| Document | Description |
|---|---|
| [ARCHITECTURE.md](ARCHITECTURE.md) | System architecture: components, abstractions, API, security, deployment, Docker. |
| [SPRINT-1.md](SPRINT-1.md) | Sprint 1 scope, decisions, repository map, and roadmap. |
