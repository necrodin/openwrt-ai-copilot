...
/**
 * Live storage operations log: shows the most recent management job triggered
 * from this page (mount / unmount / remount) with its progress, success, or
 * failure state.
 */
export function StorageOperations({ job, busy }: Props) {
  ...
  return (
    <Widget
      ...
      subtitle="Recent storage management jobs and their outcome."
    >
      {job === null ? (
        <p className="text-sm text-muted-foreground">
          No storage operations have run yet. Actions from this page appear here with their status.
        </p>
      ) : (
