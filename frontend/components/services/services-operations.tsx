...
/**
 * Live services operations log: shows the most recent management job triggered
 * from this page (start / stop / restart / enable / disable) with its progress,
 * success, or failure state.
 */
export function ServicesOperations({ job, busy }: Props) {
  ...
  return (
    <Widget
      ...
      subtitle="Recent service jobs and their outcome."
    >
      {job === null ? (
        <p className="text-sm text-muted-foreground">
          No service operations have run yet. Actions from this page appear here with their status.
        </p>
      ) : (
